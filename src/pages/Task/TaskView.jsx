...
function TaskView() {
  ...
  const handleComplete = () => {
    fetch(`https://nexaplanbackend.onrender.com/completeTask/${taskId}`, {
      method: "POST",
      body: JSON.stringify({
        done: true,
      }),
  ...
  const handleDelete = () => {
    fetch(`https://nexaplanbackend.onrender.com/deleteTask/${taskId}`, {
      method: "POST",
      body: JSON.stringify({
        delete: true,
      }),
  ...
  useEffect(() => {
    fetch(`https://nexaplanbackend.onrender.com/taskView?id=${taskId}`)
      .then((response) => response.json())
      .then((response) => {
